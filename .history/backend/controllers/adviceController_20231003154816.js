...
openai.apiKey = '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'; // こちらにあなたのOpenAI APIキーを入力してください
openai.apiKey = process.env.OPENAI_KEY; // 環境変数からOpenAI APIキーを読み込む
