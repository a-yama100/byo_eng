        ...
        <div>
            <div className="card mb-4">
                ...
                <div className="card-body">
                    <textarea className="form-control mb-3" style={{ width: '60%', backgroundColor: '#f5f5f5' }} rows="4" value={userInput} onChange={handleInputChange} /><br></br>
